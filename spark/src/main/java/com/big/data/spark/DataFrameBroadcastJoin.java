 ...
 */
public class DataFrameBroadcastJoin extends Configured implements Tool, Closeable {
    ...
    public int run(String[] args) throws Exception {
        ...
        // Broadcast => functions.broadcast(DataFrame)
        DataFrame join = parquetDFLeft.join(functions.broadcast(jsonDataframeRight), parquetDFLeft.col("emp_country").equalTo(jsonDataframeRight.col
                ("country")));
        if (LOG.isDebugEnabled()) {
