...
public class ReadFromHdfsWriteToAerospikeSparkMapPartition extends Configured implements Tool, Closeable {
    ...
    public int run(String[] args) throws Exception {
        ...
        javaSparkContext = getJavaSparkContext(conf.getBoolean(IS_RUN_LOCALLY, Boolean.FALSE), conf.get(DEFAULT_FS), ReadFromHdfsWriteToAerospikeSparkMapPartition.class);
