 ...
 */
public class EmployeeMaxBonusMapPartitionTest {

    private static final Logger LOG = LoggerFactory.getLogger(EmployeeMaxSalaryTest.class);
    private static final String BASEDIR = "/tmp/EmployeeMaxBonusMapPartitionTest/avroparquetInputFile/" + System.currentTimeMillis() + "/";
    ...
    public void testSuccess() throws Exception {
        ...
        String[] args = new String[]{"-D" + EmployeeMaxBonusMapPartition.INPUT_PATH + "=" + input,
                "-D" + EmployeeMaxBonusMapPartition.OUTPUT_PATH + "=" + output,
                "-D" + EmployeeMaxBonusMapPartition.IS_RUN_LOCALLY + "=true",
                "-D" + EmployeeMaxBonusMapPartition.DEFAULT_FS + "=file:///",
                "-D" + EmployeeMaxBonusMapPartition.NUM_PARTITIONS + "=1"};

        EmployeeMaxBonusMapPartition.main(args);
