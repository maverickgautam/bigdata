...
public class ReadKeysFromHdfsgetValuesfromAerospikeSparkMapPartitionTest {
    ...
    private static final String BASEDIR = "/tmp/ReadKeysFromHdfsgetValuesfromAerospikeSparkMapPartitionTest/avroparquetInputFile/" + System
            .currentTimeMillis()
            + "/";
    ...
    public void testSuccess() throws Exception {
        ...
        String[] args = new String[]{"-D" + ReadWriteAvroParquetFiles.INPUT_PATH + "=" + input,
                ...
                "-D" + ReadKeysFromHdfsgetValuesfromAerospikeSparkMapPartition.AEROSPIKE_NAMESPACE + "=" + runtimConfig.getNameSpaceName(),
                "-D" + ReadKeysFromHdfsgetValuesfromAerospikeSparkMapPartition.AEROSPIKE_HOSTNAME + "=127.0.0.1",
                "-D" + ReadKeysFromHdfsgetValuesfromAerospikeSparkMapPartition.AEROSPIKE_PORT + "=" + runtimConfig.getServicePort(),
